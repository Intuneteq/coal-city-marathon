...
export default function TrainingCard() {
  ...
  return (
    <div
      ...
      className="w-full lg:w-[21rem] xl:w-[23.5rem] 2xl:w-[28rem] h-[37.1875rem] px-[1.25rem] py-[2.5rem] bg-plan bg-cover bg-no-repeat rounded-2xl cursor-pointer relative flex justify-start items-end"
    >
